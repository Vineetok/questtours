...
export const customerBookings = [
  { id: 'BK-001', tour: 'Alpine Escape', status: 'Confirmed', date: '2024-05-15', price: '₹1,200', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=800&auto=format&fit=crop' },
...
export const wishlistTours = [
  { id: 'T-001', name: 'Swiss Alps Hiking', location: 'Switzerland', price: '₹2,400', rating: 4.9, image: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?q=80&w=800&auto=format&fit=crop' },
  { id: 'T-002', name: 'Moroccan Desert Safari', location: 'Morocco', price: '₹1,800', rating: 4.7, image: 'https://images.unsplash.com/photo-1509060445200-6f13a7209420?q=80&w=800&auto=format&fit=crop' },
  { id: 'T-003', name: 'Kyoto Temples', location: 'Japan', price: '₹3,200', rating: 5.0, image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=800&auto=format&fit=crop' },
];
