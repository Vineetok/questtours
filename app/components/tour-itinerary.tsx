          ...
          return (
            <div key={index} className="relative pl-12 group">
              ...
              <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-500">
                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-500 overflow-hidden ${isExpanded ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0 md:max-h-none md:opacity-100'}`}>
                ...
                <button 
                  ...
                  className="mt-8 flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-blue-600 transition-colors md:hidden"
                >
